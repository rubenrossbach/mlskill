...
#### Q1. You are part of a data science team that is working for a national fast-food chain. You create a simple report that shows a trend: Customers who visit the store more often and buy smaller meals spend more than customers who visit less frequently and buy larger meals. What is the most likely diagram that your team created?
...
#### Q2. You work for an organization that sells a spam filtering service to large companies. Your organization wants to transition its product to use machine learning. It currently uses a list of 250,000 keywords. If a message contains more than few of these keywords, then it is identified as spam. What would be one advantage of transitioning to machine learning?
...
#### Q5. Your company wants to predict whether existing automotive insurance customers are more likely to buy homeowners insurance. It created a model to better predict the best customers to contact about homeowners insurance, and the model had a low variance but high bias. What does that say about the data model?
...
#### Q52. Your supervisor asks you to create a machine learning system that will help your human resources department classify job applicants into well-defined groups. What type of system are you more likely to recommend?
...
#### Q55. If the model is trained with data in one single batch, it is known as ?
...
#### Q67. The new dataset you have just scraped seems to exhibit lots of missing values. What action will help you minimize that problem?
...
#### Q69. What is the main motivation for using activation functions in neural nets?
...
![image](images/machine-learning_Q67_ext.png)
...
#### Q77. In statistics, what is defined as the probability of a hypothesis test to find an effect - if there is an effect to be found?
